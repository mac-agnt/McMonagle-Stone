...
/**
 * The existing monthly report body: KPI row, charts, sourcing mix, depot
 * table, quote outcomes and the report archive. Unchanged from the
 * pre-toggle Reports page, just extracted so it can sit alongside the
 * daily briefing behind a view switch.
 */
